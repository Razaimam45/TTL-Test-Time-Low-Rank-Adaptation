...
from data.datautils import AugMixAugmenter, build_dataset, build_dataset_old
...
def main_worker(gpu, args):
    ...
    for set_id in datasets:
        ...
        val_dataset = build_dataset_old(set_id, data_transform, args.data, mode=args.dataset_mode)
...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', '--print-freq', default=default_print_frq, type=int,
